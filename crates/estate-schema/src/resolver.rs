...
use estate_core::{CanonicalValue, ClaimRef, Diagnostic, EntityId, Ident, RepairClass};
    ...
    pub fn new(
        ...
        if base_cost == 0 {
            return Err(Diagnostic::new(
                estate_core::diagnostic::codes::MOVEMENT_DISPOSITION_INVALID,
    ...
    pub fn new(
        ...
        for claim in &claims {
            ...
            if !seen.insert(claim.clone()) {
                return Err(Diagnostic::new(
                    estate_core::diagnostic::codes::RESOLVER_DUPLICATE_IDENTITY,
