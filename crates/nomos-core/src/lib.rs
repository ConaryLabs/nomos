...
//!
//! `nomos-core` owns the responsibility assigned by `KERNEL.md` section 10:
...
//!
//! No schema for any specific artifact. `nomos-core` knows that a package
//! holds named members of canonical bytes; it does not know what
//! `world-ir.json` means. That belongs to `nomos-schema` and
//! `nomos-projection`.
