...
//! forever. The real runtime-state envelope belongs to `nomos-sim` and will
...
use nomos_core::id::{CatalogValueId, EntityId, NamespaceId, SchemaId, StableId};
...
const GOLDEN_HASH: &str = "40a8cabed5fd8a036132acf952bdc0a0917199fca6c24e45e941e1227c0dfb12";
...
fn fixture() -> CanonicalValue {
    CanonicalValue::object_declared([
        ...
        (
            "schema",
            SchemaId::new("nomos.hash_domain_fixture", 1)
                .unwrap()
                .to_canonical(),
        ),
