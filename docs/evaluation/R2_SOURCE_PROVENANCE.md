...
Revision 4 gives each evaluation source changed by the compile-latency
classification repair a distinct revision-4 producing receipt. Unchanged
product, schema, fixture, presentation, workflow, and proof-source bytes retain
...
| --- | --- | --- | --- | --- |
| `.github/workflows/nomos-viewer.yml` | `b34ba8a680a8c3298dc7c0a5f7b6f88eeac92a5e7dea19dc48290f2b9bfc15c5` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-28-issue-199-revision-3-author/AUTHOR_RECEIPT.md` | `project_mit` |
...
| `docs/evaluation/r2-complete-proof-xfs-evidence.mjs` | `3bb673b9c29be31f6caadbbb3c61e492e70b533d8a5664a6b57b3d618541a732` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-29-issue-199-revision-4-author/AUTHOR_RECEIPT.md` | `project_mit` |
...
| `docs/evaluation/r2-complete-proof-xfs-receipt.mjs` | `0e39e86510f45cb4517070f62863b01be6f3402d145ecf36112ea25a6d465607` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-28-issue-199-revision-3-author/AUTHOR_RECEIPT.md` | `project_mit` |
| `docs/evaluation/r2-complete-proof-xfs-receipt.test.mjs` | `af1c0650d3d015b6977d4ab7583b84c179936643f72af5553dcad126d6ef526b` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-29-issue-199-revision-4-author/AUTHOR_RECEIPT.md` | `project_mit` |
| `docs/evaluation/r2-complete-proof-xfs-workdir.sh` | `0eabbda5a21aa90064c1f66f43e88b921092f4d0eb2fee4197ebb68158ecd207` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-28-issue-199-revision-3-author/AUTHOR_RECEIPT.md` | `project_mit` |
| `docs/evaluation/r2-complete-proof-xfs.sh` | `5d64d109bb91936e1678486b0763c937fcf50d3929c1db75f170f2e5b6fc9f72` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-29-issue-199-revision-4-author/AUTHOR_RECEIPT.md` | `project_mit` |
| `docs/evaluation/r2-complete-proof-xfs.test.sh` | `97978da04d35a70089f6241a2219f57f6038ffd62d20a1fd4b77343f4d1b5d3b` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-29-issue-199-revision-4-author/AUTHOR_RECEIPT.md` | `project_mit` |
...
| `docs/evaluation/r2-source-provenance.test.sh` | `eb7880b8707412a8a1753149af329135873d5fef9b2b1f61debd7ad1c469f86f` | `r2_authored` | `docs/evaluation/runs/r2/2026-08-29-issue-199-revision-4-author/AUTHOR_RECEIPT.md` | `project_mit` |
