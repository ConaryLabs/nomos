...
const TOOL_LABELS = Object.freeze([
  ...
  "install", "ip", "ld", "ln", "mkdir", "mktemp", "node", "paste", "ps", "rm", "rustc",
...
const validateMeasurements = (output) => {
  ...
  exactKeys(summary, ["outcome", "interval_ms", "samples", "initial_mib", "final_mib", "maximum_mib", "max_gap_ms"], "disk summary");
  required(summary.outcome === "pass" && summary.interval_ms === 50 && summary.samples === rows.length && summary.initial_mib === rows[0].mebibytes && summary.final_mib === rows.at(-1).mebibytes && summary.maximum_mib === maximum && summary.max_gap_ms === maximumGap, "disk summary arithmetic differs from raw rows");
