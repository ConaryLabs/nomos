...
const makeTemplate = () => {
  ...
  json(join(template, "measurements/checkout-disk-summary.json"), { outcome: "pass", interval_ms: 50, samples: 2, initial_mib: 100, final_mib: 120, maximum_mib: 120, max_gap_ms: 50 });
